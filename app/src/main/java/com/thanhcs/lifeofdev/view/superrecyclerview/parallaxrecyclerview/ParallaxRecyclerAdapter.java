package com.thanhcs.lifeofdev.view.superrecyclerview.parallaxrecyclerview;
...
public class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Set the view as header_map_search.
     *
     * @param header The inflated header_map_search
    ...
    /**
     * @return true if there is a header_map_search on this adapter, false otherwise
     */
